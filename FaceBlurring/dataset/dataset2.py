...
if __name__ == '__main__':
    ...
    ###############
    dfdict = pd.DataFrame.to_dict(pd.read_csv('../data/label_random/label/label.csv'))
    labels1 = []
    for i in range(len(dfdict['filename'])):
    ...
    if answer == 'y':
        ...
        df.to_csv('../data/label_random/label/data_label.csv')
    ###########################################    
