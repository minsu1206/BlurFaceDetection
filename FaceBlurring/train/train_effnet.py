...
if __name__ == '__main__':
    ...
    dataset = FaceDataset2('../data/label_random/label/data_label.csv', 'cosine', transform, input_size, 'rgb')
    ...
    os.makedirs("./checkpoint/effnet_112_random/", exist_ok=True)
    ...
    for epoch in range(epochs):
        ...
        scheduler.step()
        torch.save(model, f"./checkpoint/effnet_112_random/checkpoint_{epoch}.pt")
