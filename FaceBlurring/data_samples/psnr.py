...
if __name__ == '__main__':
	ref = cv2.imread('./data/FFHQ_1024/clean/00008/random_0.png')
	image_sample1 = cv2.imread('./data/FFHQ_1024/clean/00008/random_5.png')
	image_sample2 = cv2.imread('./data/FFHQ_1024/clean/00008/random_20.png')
	image_sample1 = cv2.copyMakeBorder(image_sample1, 100, 100, 100, 100, cv2.BORDER_REFLECT)
	
	image_sample1 = image_sample1[60:1224-140, 60:1224-140, :]
	resnet = InceptionResnetV1(pretrained='vggface2').eval()
	
	ref = center_crop(ref, 900)
	image_sample1 = center_crop(image_sample1, 900)
	image_sample2 = center_crop(image_sample2, 900)
	...
	plt.savefig('./blur_metric_cos.png')
