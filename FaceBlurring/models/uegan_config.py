...
def get_config():
    ...
    parser.add_argument('--image_size', type=int, default=112, help='image load resolution')
    parser.add_argument('--resize_size', type=int, default=112, help='resolution after resizing')
    parser.add_argument('--test_img_size', type=int, default=112, help='resolution after resizing')
    ...
    parser.add_argument('--g_norm_fun', type=str, default='InstanceNorm', help='BatchNorm|InstanceNorm|none')
    parser.add_argument('--d_norm_fun', type=str, default='InstanceNorm', help='BatchNorm|InstanceNorm|none')
