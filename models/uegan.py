...
import numpy as np
import functools
from uegan_config import get_config

########################################################## 
# from UEGAN/models.py
##########################################################  
...
##########################################################  
# Ref) UEGAN/trainer.py

class UEGAN(nn.Module):
    def __init__(self):
    # UEGAN/trainer.py - class Trainer / def build_model 
        super().__init__()
    ...
    # UEGAN/trainer.py - class Trainer / def init_weights
    def init_weights(self, net, init_type='orthogonal', gain=0.02):
        def init_func(m):
